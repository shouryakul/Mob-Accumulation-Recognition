...
def calculate_social_distancing(vid_path, net, output_dir, output_vid, ln1):
    ...
    while True:
        ...
        print("No. of people: ",person_count)
        ...
        img = plot.social_distancing_view(frame1, bxs_mat, boxes1, risk_count,CROWD_THRESHOLD)
...
if __name__== "__main__":
    ...
    parser.add_argument('-v', '--video_path', action='store', dest='video_path', default='./data/street.webm' ,
