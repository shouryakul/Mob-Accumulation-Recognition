...
def social_distancing_view(frame, distances_mat, boxes, risk_count, CROWD_THRESHOLD):
    ...
    person_count = risk_count[0]+risk_count[1]+risk_count[2]
    person_count_color = green;
    if(person_count > CROWD_THRESHOLD):
        person_count_color = red; 
    ...
    cv2.putText(pad, "No. of people : " + str(risk_count[0]+risk_count[1]+risk_count[2]), (50,  130), cv2.FONT_HERSHEY_SIMPLEX, 0.6, person_count_color, 1)
